<img align="right" width="15%" src="https://raw.githubusercontent.com/Voltstro-Studios/VoltRpc/master/media/icon.svg">
...
- Supports all built-in C# value types, including:
    ...
    - `ULong`
    - `UShort`
- Supports these built-in C# reference types: (More to be added)
    - `String`
- Supports arrays for any type
- Easily support [custom types](https://voltrpc.voltstro.dev/articles/types#custom-types) by implementing a ITypeReadWriter
