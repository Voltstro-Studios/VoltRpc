...
public static class ProxyCodeTemplates
{
    private const string AutoGeneratedWarning =
        $@"//------------------------------------------------------------------------------
// <auto-generated>
//     This code was auto-generated by {ThisAssembly.AssemblyTitle}, version {ThisAssembly.AssemblyInformationalVersion}.
//
...
{{{{
    /// <inheritdoc />
    [GeneratedCode(""{ThisAssembly.AssemblyTitle}"", ""{ThisAssembly.AssemblyInformationalVersion}"")]
    {{4}} sealed class {{1}} : {{2}}
    {{{{
